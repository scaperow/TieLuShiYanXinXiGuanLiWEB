<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="HistoryfailReport.aspx.cs" Inherits="report_HistoryfailReport" %>
    ...
    <script type="text/javascript">
        ...
        function createChart() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "<%= ResolveUrl("HistoryfailReport.aspx") %>",
                data: data,
