<%@ Page Language="C#" AutoEventWireup="true" CodeFile="parallelchartgrid.aspx.cs" Inherits="report_parallelchartgrid" %>
 ...
 <script type="text/javascript" src="<%= ResolveUrl("~/js/jquery-1.9.0.min.js") %>"></script>
    ...
    <script type="text/javascript">
        ...
        function getGridOption() {
            var data = getSearchCondition("parallelchartgrid");
            var obj = {
