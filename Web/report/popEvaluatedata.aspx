<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popEvaluatedata.aspx.cs" Inherits="report_popEvaluatedata" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.ajax({
                ...
                dataType: "json",
                async: false,
                url: "<%= ResolveUrl("~/ajax/ajaxChart.aspx?StartDate="+"StartDate".RequestStr()+"&EndDate="+"EndDate".RequestStr()+"&sType=evaluatedatapop&sTestcode=") %>" + code + "&r=" + Math.random(),
        ...
        function handleClick(data) {
            $.colorbox({
                href: "../baseInfo/popfailgrid.aspx?testcode=" + data.dataItem.dataContext.Para1 + "&r=" + Math.random(),
                width: 960,
                height: 500,
                title: function () {
