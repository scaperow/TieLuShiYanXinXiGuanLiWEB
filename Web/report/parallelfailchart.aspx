<%@ Page Language="C#" AutoEventWireup="true" CodeFile="parallelfailchart.aspx.cs" Inherits="report_parallelfailchart" %>
    ...
    <script type="text/javascript">
        ...
        function BindCharts(type, n, title) {
            ...
            $.ajax({
                ...
                dataType: "json",
                async: false,
                url: "<%= ResolveUrl("~/ajax/ajaxChart.aspx?sType=parallelfailchart&sTestcode=") %>" + code + "&IsUnit=" + n + "&r=" + Math.random(),
        ...
        function handleClick(e) {
            $.colorbox({
                href: "parallelchartgridfail.aspx?testroomid=" + e.dataItem.dataContext.Para1 + "&modelid=" + e.dataItem.dataContext.Para2 + "&sNuit=" + e.dataItem.dataContext.Para3 + "&r=" + Math.random(),
                width: 700,
                height: 500,
                title: function () {
