<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popBaseSummary.aspx.cs" Inherits="baseInfo_popBaseSummary" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.ajax({
                ...
                dataType: "json",
                async: false,
                url: "<%= ResolveUrl("~/ajax/ajaxChart.aspx?sType=qxzlhzbchartpop&sTestcode=") %>" + code + "&r=" + Math.random(),
        ...
        function handleClick(e) {
            ...
            $.colorbox({
                href: "charttogrid.aspx?testroomid=" + testcode + "&modelid=" + e.dataItem.dataContext.Para1 + "&r=" + Math.random(),
                width: 800,
                height: 500,
                title: function () {
                    return "" + e.dataItem.dataContext.Description + "[" + e.dataItem.dataContext.Para2 + " " + $('#hd_startDate').val()
                        + " 至 " + $('#hd_endDate').val() + "]";
                },
                close: '×',
                size:12,
